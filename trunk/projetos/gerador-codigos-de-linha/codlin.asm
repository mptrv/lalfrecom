...
inicio
	...
	MOVLW 0x83 ;8MILISEGUNDOS
	MOVWF OPTION_REG

	; Habilita interrupçao por TIMER 1.
...
RTI_TMR1
	...
	BTFSS STATUS,Z ; TESTA SE CONTA_BIT É 0
	GOTO DESLOCA
...
TIPO1
	...
	MOVLW	.1	
	SUBWF	TIPO,W
	BTFSS	STATUS,Z ;QDO DA 0 O FLAG DE ZERO É 1
	GOTO	TIPO2
	MOVFW	AUX
	MOVWF	AUX1
...
PULA_DESLOCA
	...
	BTFSC AUXT,7 ; TESTE SE O BIT ATUAL É 1 OU 0
	GOTO TESTA_SETADO ; PARA CONSEGUIR GERAR TENSÃO POSITIVA E NEGATIVA
	BCF PORTC,3
	BSF PORTC,4 ;VALOR INVERSO DO PORTC,3 

TESTA_SETADO

	BTFSS AUXT,7 ; TESTE SE O BIT ATUAL É 1 OU 0
